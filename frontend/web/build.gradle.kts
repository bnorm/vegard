...
dependencies {
  ...
  implementation("org.jetbrains:kotlin-react-dom:16.13.1-pre.120-kotlin-1.4.10")
  implementation("org.jetbrains:kotlin-react-router-dom:5.1.2-pre.120-kotlin-1.4.10")
