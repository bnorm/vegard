...
dependencies {
  ...
  implementation("org.jetbrains:kotlin-extensions:1.0.1-pre.116-kotlin-1.4.10")
  implementation("org.jetbrains:kotlin-react:16.13.1-pre.116-kotlin-1.4.10")
  implementation("org.jetbrains:kotlin-react-dom:16.13.1-pre.116-kotlin-1.4.10")
