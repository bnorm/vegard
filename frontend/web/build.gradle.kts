...
dependencies {
  ...
  implementation("org.jetbrains:kotlin-extensions:1.0.1-pre.122-kotlin-1.4.10")
  ...
  implementation("org.jetbrains:kotlin-react-router-dom:5.1.2-pre.122-kotlin-1.4.10")
